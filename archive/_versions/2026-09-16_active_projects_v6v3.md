---
type: current_state
last_updated: 2026-09-16 02:45 (ハタチたち5 説明会 構成v6_v2 完成・FCP読み込み確認中)
...
### 3. 平成たち祭 動画制作
- **★ 2026-09-16 深夜 ハタチたち5 説明会 構成v6_v2 完成 (FCP 読み込み確認中)**:
  - 納品 `_FCP納品/ハタチたち5説明会_構成v6_v2.fcpxml`。4K 59.94p、本編 6:22.2 (382.2秒) + エンドカード6秒、ショット48・字幕28枚・丸窓28クリップ。DTD 検証 OK、構造チェック0件。YouTube 用全文 SRT 95件 (`_FCP納品/字幕_構成v6タイムライン基準_全文.srt`、生成器 `_cc_work/make_srt_v6.py`)
  ...
  - v5_v2 は FCP 読み込み確認済 (メディア欠落ゼロ、丸窓実寸OK、字幕16点全件)。v6_v2 は読み込み・実画確認中
