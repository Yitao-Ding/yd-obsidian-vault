---
type: current_state
last_updated: 2026-08-08 (Arte Grow: 軸を「映像で伝える」に再定義・渡航10/1-2確定・Notion新ページ新設、詳細#5 / 旧2026-08-05注記: CC-business: noteオンリー分売の全7記事完成原稿・YD承認済 / 平成たち祭: 時系列整列TL2本追加。詳細は各セクション参照。※frontmatter 21日放置を外部監査2026-08-05指摘5で是正、旧7/14注記はCC-business本文へ)
...
- **欠番**: 7演目 (1-1, 1-3, 1-6, 1-7, 1-9, 2-2, 2-4) 後日リンク到着予定 → フォルダ内 `_欠番リスト.md` で管理
...
- **未確定**: テロップ表記リスト / 演目順 / スタッフクレジット内容 / 納品形式(2:02切りか黒含め全長か) / 納期 → 正本=`_案件仕様.md`
