...
- **仕様確定 (2026-08-02)**: 音源=「えんとつ町のプペル」(毎回同じ) / 映像は頭から**2:02**まで(紗幕上がってコレオ実登場→以降音源のみ、音源全体約3:56) / 参照=前回エンドロール(`_参照/前回エンドロール_参照.mp4`、IG reel DYJiK0_z9jB)
- **未確定**: 書き出し解像度 / 音源データ受領方法 / テロップ表記リスト / 演目順 / 納期 → 正本=`_案件仕様.md`
