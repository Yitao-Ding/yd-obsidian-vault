...
type: research
source: arxiv
source_id: '2607.25967'
url: http://arxiv.org/abs/2607.25967v1
published_at: '2026-07-28T16:47:59+00:00'
collected_at: '2026-07-29T07:07:51.163895+00:00'
score: 1.52
importance: 2
categories:
- infra
...
> http://arxiv.org/abs/2607.25967v1

## 要約 (日本語5行)

SVD (特異値分解) をリアルタイムGPU処理向けに最適化したQuas-SVDを提案。一方の因子に正確な直交性をLie群で保証、もう一方をソフト制約で回復することで3〜20倍高速化達成。医療画像2シーン（超音波顕微鏡背景除去・神経手術偏光計測）で25+FPSクリア。再構成忠実度はSSIM 0.89-0.94で臨床水準達成。オフライン精度より「ライブ画像診断が可能か」を優先した実用志向の行列分解アルゴリズム。</parameter_ja>
</invoke>
...
*Generated by ai-researcher at 2026-07-29T07:07:51.164685+00:00*