...
published_at: '2026-07-12T18:28:15+00:00'
collected_at: '2026-07-14T16:04:41.999741+00:00'
score: 10.0
importance: 4
categories:
- agents
...
Juggler は JUCE 作者による GUI コーディングエージェント。CRDT ドキュメントベース・ Miller Column UI・JavaScript プラグイン API・ローカルサーバー + マルチクライアント接続が特徴。AGPLv3 オープンソース・認証不要・テレメトリーなし。Claude・OpenAI・Gemini・Ollama 対応。
...
*Generated by ai-researcher at 2026-07-14T16:04:42.000571+00:00*