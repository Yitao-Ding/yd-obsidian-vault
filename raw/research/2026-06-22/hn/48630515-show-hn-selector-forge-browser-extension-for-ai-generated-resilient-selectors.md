...
published_at: '2026-06-22T14:21:24+00:00'
collected_at: '2026-06-23T00:04:10.329349+00:00'
score: 10.0
importance: 3
categories:
- code-llm
...
Intuned チームが開発したブラウザ拡張で、AI が CSS/XPath セレクタを自動生成します。従来の DevTools の「Copy Selector」よりも意味的で、ページ変化に耐性のある robust なセレクタを生成するのが特徴です。ブラウザオートメーション開発で最も脆い部分であるセレクタ選定を自動化し、自動化コードの品質と安定性を大幅に向上させます。aria-label や XPath の following-sibling などを活用した semantic selector により、ページレイアウト変更にも強い設計になっています。オープンソース化されており、Chrome と Firefox で利用可能です（月200個まで無料、無制限プランも提供）。
...
*Generated by ai-researcher at 2026-06-23T00:04:10.330266+00:00*