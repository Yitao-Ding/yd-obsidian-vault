...
> https://huggingface.co/papers/2608.22849

## 要約 (日本語5行)

完全長RNA転写体のシングルヌクレオチド解像度での建模を実現する1.61B parameter foundation model。最大10,240 nt のコンテキスト長でネイティブプレトレーンし、長RNA上の文脈的応答性を維持。33型のRNA素性別表現学習で最先端を達成。離散拡散フレームワークで完全長mRNA生成・再設計に対応し、同義コドン最適化による蛋白質保存CDS設計も実装。RNAの大規模言語モデルとして、配列→構造→機能の連鎖を学ぶ新しいパラダイム。
...
*Generated by ai-researcher at 2026-08-25T09:04:11.506479+00:00*