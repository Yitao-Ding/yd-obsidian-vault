...
type: research
source: arxiv
source_id: '2608.06331'
url: http://arxiv.org/abs/2608.06331v1
published_at: '2026-08-06T17:40:26+00:00'
collected_at: '2026-08-07T06:08:25.813261+00:00'
score: 2.52
importance: 4
categories:
- code-llm
...
TYTAN はリレーショナルデータベースから分析用セマンティックスキーマを自動構築するシステムです。シンボリック分析と LLM ベースの推論を組み合わせ、エンティティ・役割・命名を同時に行います。ユーザーの短い記述と曖昧性解決の対話を通じて、手作業が不要なスキーマ自動化を実現しました。評価では 100% のカバレッジ、全 retrieval 指示の正確性、92-100% の意味的役割一致を達成しています。neurosymbolic な approach は RAG/自然言語インターフェースの semantic layer 自動化に向いています。
...
*Generated by ai-researcher at 2026-08-07T06:08:25.814042+00:00*