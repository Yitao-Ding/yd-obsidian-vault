...
collected_at: '2026-09-02T02:05:55.093263+00:00'
score: 5.53
importance: 4
categories:
- rag
...
> https://huggingface.co/papers/2608.30468

## 要約 (日本語5行)

多段階質問応答において、質問の粒度と検索可能な証拠の粒度のミスマッチを、動的なクエリツリー成長で解決するHi-Qを提案しています。各クエリノードで証拠による検証を行い、未解決なら二項演算子で拡張する仕組みです。IRCoTやPropRAGより15EM以上の改善を複数ベンチマークで達成しており、検索精度が高まります。このアプローチはエージェント推論の階層的分解に直結し、RAGシステムの多段階推論を実装する際の実用的な手法です。lecture_hubのような知識ハブでの複雑な質問応答に活かせるポテンシャルがあります。
...
*Generated by ai-researcher at 2026-09-02T02:05:55.094186+00:00*