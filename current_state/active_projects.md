---
type: current_state
last_updated: 2026-09-15 19:00 (ハタチたち5 説明会動画 FCP自動編集 納品)
...
### 3. 平成たち祭 動画制作
- **★ 2026-09-15 ハタチたち5 説明会動画 (A027C007、10:52) を FCP プロジェクトとして自動編集・納品**: Apple発表会風 (カット済み8:39+エンドカード / ワイド11・寄り16・スライド全面28・動画全画面16 / 字幕120本 / 顔追従の丸窓)。FCPXML v5 を `YITAO's FILE/final cut pro/26.9.15~.fcpbundle` の「ハタチたち5 説明会 v7」に読み込み済み。納品物とREADMEは `/Volumes/Extreme pro/平成たち祭２/ハタチたち説明会&座談会/_FCP納品/`。**YD次アクション**: 通し視聴 → 字幕の固有名詞 (ゆうほ/りお表記) とエンドカード文言 (応募フォームURL/QR) を確定 → 書き出し → SNS投稿 (募集締切 9/30)。検証用イベント v3〜v6 と未登録フォルダ v1/v2 は削除可。手順知見は [[fcpxml_auto_edit_pipeline]]、決定は [[2026-09-15_ハタチたち5説明会動画_FCP自動編集]]
