...
### 3. 平成たち祭 動画制作
- **★ 2026-09-15 ハタチたち5 説明会動画 4K 60p v2 FCP 読み込み済み**: YD 指示「画質優先、4K 60p」で 1080p → 3840×2160/59.94p に変更。build_fcpxml_4k.py で再生成、Canva スライドは PDF → pdf2png4k.py で 4K PNG、PIP は 5 分割並列エンコード。`_FCP納品/ハタチたち5説明会_4K_v2.fcpxml` を `26.9.15~.fcpbundle` に読み込み済み・目視確認中。**YD次アクション**: 4K v2 を通し視聴 → 字幕の固有名詞 (ゆうほ/りお表記) とエンドカード文言 (応募フォームURL/QR) を確定 → 書き出し → SNS投稿 (募集締切 9/30)。手順知見は [[fcpxml_auto_edit_pipeline]]、決定は [[2026-09-15_ハタチたち5説明会動画_FCP自動編集]] / [[2026-09-15_ハタチたち5説明会_4K60p化]]
