...
- **投入内容** (6/24時点データ + 進捗反映):
  - 動画5: ①ダンスでチャリティーWS(千葉)編集[納6/26] ②長野インタビュー編集[**✅2026-07-14 編集完成・YD検収待ち**: 前後編4K 2本 (全字幕方式、DaVinci API自動構築)、成果物=`2025-07-06_Nagano/render/`、詳細=[[2026-07-14_長野ドキュメンタリー_全字幕方式完成]]] ③**ハイミ「蛹」**MV[納6/29] ④平成たち祭メイキング&ダイジェスト[納7/12] ⑤JAMBOREE STUDIO BATTLE Lite OP『THE EYE / 開眼』[📦納品済7/5・¥70,000]
