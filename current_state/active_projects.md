...
### プペル ゆかやねん夜 iPhone素材 (IMG_2202) FX30色合わせ + 音声差し替え (2026-09-05 完了)
- **状況**: ✅ 書き出し完了 → `プペル/number/ゆかやねん/ゆかやねん_夜_IMG2202_FX30match.mp4` (3840×2160 / 30p / HEVC 10bit 30.7Mbps / 229.7s / 881MB / AAC 320k)。ギガファイル便 https://1.gigafile.nu/1214-o31bc424dcd836a75ea4eade6814cfdc6 (期限 2026-12-14)。はるきさんへの送付は YD
- **素材**: `~/Downloads/IMG_2202.mov` (iPhone 12 Pro 引き、夜公演) + 音声・色基準 = `ゆかやねん_夜_寄り.MP4` (FX30)
- **同期**: FX30 が 0.3728s 遅れて開始、ドリフト -25.7ppm。出力と iPhone 元音声の波形相関 +5ms
- **色**: ホモグラフィで同一画素ペアを作り、露出比 (top-20画素) を外してから アフィン+MLP を分布一致で学習。赤/緑/琥珀の色相と黒の浮きは一致。ビームとダンサーの明るさ比 (iPhone は正面散乱で光線が10倍明るい) は点変換では合わず、白スポット場面はダンサーが 0.5 段暗め
- **作業一式**: `プペル/number/_grade/ゆかやねん_IMG2202_色合わせ/` (README + scripts + model8.pt + gain_t_final.npy)。知見 = [[iphone_to_fx30_color_match]]
