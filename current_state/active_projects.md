...
### プペル ゆかやねん夜 iPhone素材 (IMG_2202) FX30色合わせ + 音声差し替え (2026-09-08 v4 レンダー中)
- **状況**: 🔄 v4 レンダー中 (`/tmp/yuka/yuka_final_v4.mp4`、約23分、2026-09-08 20:04 開始)。完了後に FX30 比較 → Extreme Pro 転送 → ギガファイル再アップ → はるきさん確認が次ステップ。v3 ギガファイル便 **https://22.gigafile.nu/1215-e3e5c46c86c2f3016bba013f852b57637** (期限 2026-12-15) はまだ有効だが v4 で差し替え予定。v1 (白飛び) / v2 (暗部暗め) のリンクは使わない。ローカル旧版は `ゆかやねん/_old/`
